...
function openSocial(type) {
  ...
  switch (type) {
    case 'discord':
           return alert('KBCats#5605');
    case 'github':
      url = 'https://github.com/kbcats';
      break;
    case 'youtube':
      url = 'https://youtube.com/kbcat';
      break;
  }
...
function typerStartTyping(typer) {
  ...
  let text = ['html', 'css', 'javascript', 'python','scratch','extension','shit malware'];
